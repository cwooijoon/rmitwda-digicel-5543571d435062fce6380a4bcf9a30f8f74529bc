                                           ...
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													...
													<ul>
														...
														<li>
															<a href="distributor/<?php echo $brand->brand_id; ?>"><?php echo $brand->brand_name; ?> </a> |
															<a href="distributor/<?php echo $brand->brand_id; ?>/edit">Edit</a>
														</li>
														<?php endforeach; ?>
													</ul>
													...
													<ul>
														<li>
															<a href="distributor/<?php echo $template->brand->brand_id; ?>"><?php echo $template->brand->brand_name; ?> </a> |
															<a href="distributor/<?php echo $template->brand->brand_id; ?>/edit">Edit</a>
														</li>
													</ul>
													<?php else: ?>
													<p>No brands found.</p>

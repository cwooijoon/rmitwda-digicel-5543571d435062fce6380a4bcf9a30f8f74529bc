                                           ...
                                           <tr><td >
												...
												<table border="0" align="center" bgcolor="#99ccff">
													<tr>
														<td>Brand Name:</td>
														<td>
															<input type="text" name="brand_name" value="<?php echo $template->brands['brand_name']; ?>" />
														</td>
														<td>
															<?php
															if(isset($template->errors['brand_name']))
															{
															echo $template->errors['brand_name'];
															}
															?>
														</td>
													</tr>
													...
													<tr>
														<td>Distributor:</td>
														<td>
															<?php if(count($template->distributors) > 1 ): ?>
															<select name="dist_id">
															<?php foreach($template->distributors as $distributor): ?>
															<option value="<?php echo $distributor->dist_id; ?>"><?php echo $distributor->dist_name; ?></option>
															<?php endforeach; ?>
															</select>
															<?php else: ?>
															<select name="dist_id">
															<option value="<?php echo $template->distributors->dist_id; ?>"><?php echo $template->distributors->dist_name; ?></option>
															</select>
															<?php endif; ?>
														</td>
													</tr>
													...
													<tr>
														<td>
															<input type="submit" name="create_brand" value="Create" />
														</td>
														<td></td>
														<td></td>
													</tr>

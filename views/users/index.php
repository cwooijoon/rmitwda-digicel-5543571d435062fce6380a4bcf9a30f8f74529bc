                                    ...
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
                                                    	<?php if(count($template->users) > 1): ?>
														<ul>
															<?php foreach ($template->users as $user): ?>
															<li>
																<a href="users/<?php echo $user->user_id; ?>"><?php echo $user->name; ?> (<?php echo $user->username; ?>)</a> |
																<a href="users/<?php echo $user->user_id; ?>/edit">Edit</a>
															</li>
															<?php endforeach; ?>
														</ul>
														<?php elseif(count($template->users) == 1): ?>
														<ul>
															<li>
																<a href="users/<?php echo $template->users->user_id; ?>"><?php echo $template->users->username; ?> </a> |
																<a href="users/<?php echo $template->users->user_id; ?>/edit">Edit</a>
															</li>
														</ul>
														<?php else: ?>
														<p>An error has occured. No users found.</p>
														<?php endif; ?>
													</td></tr>
                                                </table>
                                            </td></tr>

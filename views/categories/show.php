                            ...
                            <td valign="top" Align ="center"> 
                                ...
                                <table border="0" width="100%">
                                       ...
                                       <table border="0" width="100%"><tr><td width="90%" class="menulink" align="center">
												<?php if (isset($template->categories)): ?>	<br />
                                                This is the show page for the brand "<?php echo $template->categories->category_name;
												?>" and the id "<?php echo $template->categories->category_id; ?>"
                                            </td></tr></table>
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 								
                                                    <ul>
														<li>Name: <?php echo $template->categories->category_name; ?></li>
													</ul>
													<?php else: ?>
													<h2>The category with id "<?php echo $template->id; ?>" does not exist</h2>
													<?php endif; ?>
													</td></tr>
                                                </table>
                                            </td></tr>

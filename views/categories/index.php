                                    ...
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
                                                     	<?php if(count($template->categories) > 1): ?>
														<ul>
															<?php foreach ($template->categories as $category): ?>
															<li>
																<a href="categories/<?php echo $category->category_id; ?>"><?php echo $category->category_name; ?> </a> |
																<a href="categories/<?php echo $category->category_id; ?>/edit">Edit</a>
															</li>
															<?php endforeach; ?>
														</ul>
														<?php elseif(count($template->categories) == 1): ?>
														<ul>
															<li>
																<a href="categories/<?php echo $template->categories->category_id; ?>"><?php echo $template->categories->category_name; ?> </a> |
																<a href="categories/<?php echo $template->categories->category_id; ?>/edit">Edit</a>
															</li>
														</ul>
														<?php else: ?>

                                                    ...
                                                    <form method="POST" action="create">
														<table border="0" align="center" bgcolor="#99ccff">
															<tr>
																<td>Category Name:</td>
																<td>
																	<input type="text" name="category_name" value="<?php echo $template->categories['category_name']; ?>" />
																</td>
																<td>
																	<?php
																	if(isset($template->errors['category_name']))
																	{
																	echo $template->errors['category_name'];
																	}
																	?>
																</td>
															</tr>
															<tr>
																<td>
																	<input type="submit" name="create_category" value="Create" />
																</td>
																<td></td>
																<td></td>
															</tr>

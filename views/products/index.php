                                    ...
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
                                                    <p>Choose hardware type:</p>
													<ul>
														<li><a href="products/processors">Processors</a></li>
														<li><a href="products/motherboards">Motherboards</a></li>
														<li><a href="products/rams">RAMs</a></li>
														<li><a href="products/harddisks">Harddisks</a></li>
														<li><a href="products/optical_roms">ROMs</a></li>
														<li><a href="products/graphics">Graphic Cards</a></li>

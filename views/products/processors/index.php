                            ...
                            <td valign="top" Align ="center"> 
                                ...
                                <table border="0" width="100%">
                                       ...
                                       <table border="0" width="100%"><tr><td width="90%" class="menulink" align="center">
                                                This is the index page for <?php echo strtolower($template->title); ?>
                                            </td></tr></table>
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
													<?php if(count($template->processors) > 1): ?>
													<ul>
													<?php foreach ($template->processors as $processor): ?>
														<li>
															<a href="products/processors/<?php echo $processors->product_id; ?>">
															<?php echo $processors->proc_name; ?> - 
															<?php echo $processors->proc_model; ?> - 
															<?php echo $processors->proc_speed; ?>
															</a> |
															<a href="products/processors/<?php echo $processors->product_id; ?>/edit">Edit</a>
														</li>
														<?php endforeach; ?>
													</ul>
													<?php elseif(count($template->brand) == 1): ?>
													<ul>
														<li>
															<a href="distributor/<?php echo $template->processors->product_id; ?>">
															<?php echo $template->processors->proc_name; ?> - 
															<?php echo $template->processors->proc_model; ?> - 
															<?php echo $template->processors->proc_speed; ?>
															</a> |
															<a href="distributor/<?php echo $template->processors->product_id; ?>/edit">Edit</a>
														</li>
													</ul>
													<?php else: ?>

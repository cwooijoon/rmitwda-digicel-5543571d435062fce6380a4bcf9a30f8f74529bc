                                    ...
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
                                                     	<?php if(count($template->distributor) > 1): ?>
														<ul>
															<?php foreach ($template->distributor as $dist): ?>
															<li>
																<a href="distributor/<?php echo $dist->dist_id; ?>"><?php echo $dist->dist_name; ?> </a> |
																<a href="distributor/<?php echo $dist->dist_id; ?>/edit">Edit</a>
															</li>
															<?php endforeach; ?>
														</ul>
														<?php elseif(count($template->distributor) == 1): ?>
														<ul>
															<li>
																<a href="distributor/<?php echo $template->distributor->dist_id; ?>"><?php echo $template->distributor->dist_name; ?> </a> |
																<a href="distributor/<?php echo $template->distributor->dist_id; ?>/edit">Edit</a>
															</li>
														</ul>
														<?php else: ?>

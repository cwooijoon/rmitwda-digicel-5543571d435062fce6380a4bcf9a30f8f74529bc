                            ...
                            <td valign="top" Align ="center"> 
                                ...
                                <table border="0" width="100%">
                                       <tr><td colspan =" 2" align="center">
										<?php if (isset($template->distributor)): ?>
                                       <table border="0" width="100%"><tr><td width="90%" class="menulink" align="center">
                                                This is the show page for the distributor "<?php echo $template->distributor->dist_name;
												?>" and the id "<?php echo $template->distributor->dist_id; ?>"
                                            </td></tr></table>
                                    <table border="0" width="100%" cellpadding="3" >
                                           <tr><td >
                                                <table border="0" align="center" bgcolor="#99ccff">
													<tr><td> 
                                                    <ul>
														<li>Name: <?php echo $template->distributor->dist_name; ?></li>
														<li>Contact: <?php echo $template->distributor->contact_number; ?></li>
														<li>Email: <?php echo $template->distributor->email; ?></li>
													</ul>
													<?php else: ?>
													<h2>The distributor with id "<?php echo $template->id; ?>" does not exist</h2>
													<?php endif; ?>
													</td></tr>
                                                </table>
                                            </td></tr>
